...
Your task is to define the following two methods for the Coordinate class:
 ...
 2   Define __repr__, a special method that returns a string that looks like a valid Python expression 
...
class Coordinate(object):
    ...
    # to do
    # an __eq__ method that returns True if coordinates refer to same point in the plane (i.e., have the same x and y coordinate)
